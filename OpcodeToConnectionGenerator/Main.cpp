...
void DumpSpellFailures()
{
    ...
    pGetErrorString GetStringReason = (pGetErrorString)((DWORD_PTR)GetModuleHandle(nullptr) + 0x268F070);
...
void DumpInventoryErrors()
{
    ...
    UIErrorInfo* uis = (UIErrorInfo*)((DWORD_PTR)GetModuleHandle(nullptr) + 0x4435A80);

    using GetGameErrorFn = int(__fastcall*)(int);
    GetGameErrorFn CGBag_C_GetGameError = (GetGameErrorFn)((DWORD_PTR)GetModuleHandle(nullptr) + 0x28FEA50);
