...
{
    static std::uintptr_t const UIErrorsOffset = 0xC549A8;
    static std::size_t const UIErrorsSize = 950;
...
{
    static std::uintptr_t const FrameXML_EventsOffset = 0xDF6070;
    static std::size_t const FrameXML_EventsSize = 1021;
