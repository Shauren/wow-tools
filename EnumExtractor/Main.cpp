...
{
    static std::uintptr_t const UIErrorsOffset = 0x408D960;
    static std::size_t const UIErrorsSize = 1129;
...
int main()
{
    std::shared_ptr<Process> wow = ProcessTools::Open(_T("Wow_10.2.5.52902-T-64_orig.exe"), 52902, true);
    if (!wow)
        return 1;
