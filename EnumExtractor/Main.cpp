...
{
    static std::uintptr_t const UIErrorsOffset = 0xC58A60;
...
{
    static std::uintptr_t const FrameXML_EventsOffset = 0xDFA238;
    static std::size_t const FrameXML_EventsSize = 1034;
