...
namespace UpdateFieldCodeGenerator.Formats
{
    public class TrinityCoreHandler : UpdateFieldHandlerBase
    {
        ...
        public override void BeforeStructures()
        {
            ...
            _header.WriteLine("#ifndef TRINITYCORE_UPDATE_FIELDS_H");
            _header.WriteLine("#define TRINITYCORE_UPDATE_FIELDS_H");
            _header.WriteLine();
            ...
            _header.WriteLine("#include \"UpdateFieldsAaBox.h\"");
            ...
            _source.WriteLine("#include \"UpdateFieldImpl.h\"");
            _source.WriteLine("#include \"ViewerDependentValues.h\"");
            _source.WriteLine();
            WriteAutogeneratedDisclaimer(_source);
            _source.WriteLine("#if TRINITY_COMPILER_IS_GCC");
        ...
        public override void AfterStructures()
        {
            _header.WriteLine("}");
            _header.WriteLine();
            _header.WriteLine("#endif // TRINITYCORE_UPDATE_FIELDS_H");
        ...
        private void WriteField(string name, string access, Type type, int bitSize)
        {
            ...
            switch (Type.GetTypeCode(type))
            {
                case TypeCode.Object:
                    if (type == typeof(WowGuid) || type == typeof(Vector2) || type == typeof(Vector3) || type == typeof(AaBox) || type == typeof(DungeonScoreSummary)
        ...
        private void WriteFieldDeclaration(string name, UpdateField declarationType, string nameForIndex)
        {
            ...
            if (_writeUpdateMasks)
            {
                ...
                else if (typeof(DynamicUpdateField).IsAssignableFrom(declarationType.Type))
                {
                    ...
                    typeName = TypeHandler.GetFriendlyName(elementType);
                    fieldGeneratedType = _dynamicUpdateFieldType.MakeGenericType(elementType,
                        CppTypes.CreateConstantForTemplateParameter(blockIndex),
                        bit);
                }
                else if (typeof(MapUpdateField).IsAssignableFrom(declarationType.Type))
                {
                    var keyType = PrepareFieldType(fieldGeneratedType.GenericTypeArguments[0]);
        ...
        private static string GetClassForObjectType(ObjectType objectType)
        {
            switch (objectType)
            {
                ...
                case ObjectType.HousingDecor:
                    return "Object"; // MeshObject
                case ObjectType.HousingRoom:
                    return "BaseEntity";
                case ObjectType.HousingRoomComponentMesh:
                    return "Object"; // MeshObject
                case ObjectType.HousingPlayerHouse:
                    return "BaseEntity";
                ...
                case ObjectType.MirroredPositionData:
                    return "BaseEntity";
                case ObjectType.PlayerHouseInfoComponent:
                    return "Player";
                case ObjectType.HousingStorage:
                    return "BaseEntity";
