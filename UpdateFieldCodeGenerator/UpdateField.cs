...
namespace UpdateFieldCodeGenerator
{
    public class UpdateField
    {
        ...
        public UpdateField(Type type, UpdateFieldFlag flag, int size = 0, int bitSize = 0, CustomUpdateFieldFlag customFlag = CustomUpdateFieldFlag.None, string comment = null, [CallerLineNumber] int order = 0)
        {
            ...
            (Type, Flag, Size, BitSize, CustomFlag, Comment, Order) = (type, flag, size, bitSize, customFlag, comment, order);
        }

        public UpdateField(Type type, UpdateFieldFlag flag, FieldInfo sizeForField, int size = 0, int bitSize = 0, CustomUpdateFieldFlag customFlag = CustomUpdateFieldFlag.None, string comment = null, [CallerLineNumber] int order = 0)
            : this(type, flag, size, bitSize, customFlag, comment, order)
        {
