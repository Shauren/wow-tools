...
namespace UpdateFieldCodeGenerator.Structures
{
    public class JamMirrorDelveData_C
    {
        ...
        public static readonly UpdateField field_8 = new UpdateField(typeof(ulong), UpdateFieldFlag.None);
        ...
        public static readonly UpdateField m_ownersSize = new UpdateField(typeof(BlzVectorField<WowGuid>), UpdateFieldFlag.None, typeof(JamMirrorDelveData_C).GetField("m_owners", BindingFlags.Static | BindingFlags.Public));
