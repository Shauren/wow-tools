...
namespace UpdateFieldCodeGenerator.Structures
{
    public class CGGameObjectData
    {
        ...
        public static readonly UpdateField m_stateSpellVisualID = new UpdateField(typeof(uint), UpdateFieldFlag.None);
        public static readonly UpdateField m_spawnTrackingStateAnimID = new UpdateField(typeof(uint), UpdateFieldFlag.None);
        public static readonly UpdateField m_spawnTrackingStateAnimKitID = new UpdateField(typeof(uint), UpdateFieldFlag.None);
        public static readonly UpdateField m_stateWorldEffectIDsSize = new UpdateField(typeof(BlzVectorField<int>), UpdateFieldFlag.None, typeof(CGGameObjectData).GetField("m_stateWorldEffectIDs", BindingFlags.Static | BindingFlags.Public));
        public static readonly UpdateField m_stateWorldEffectsQuestObjectiveID = new UpdateField(typeof(uint), UpdateFieldFlag.None);
        public static readonly UpdateField m_stateWorldEffectIDs = new UpdateField(typeof(BlzVectorField<uint>), UpdateFieldFlag.None);
        ...
        public static readonly UpdateField m_level = new UpdateField(typeof(int), UpdateFieldFlag.None, customFlag: CustomUpdateFieldFlag.ViewerDependent);
        ...
        public static readonly UpdateField m_artKit = new UpdateField(typeof(byte), UpdateFieldFlag.None);
