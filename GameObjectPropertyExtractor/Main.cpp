...
{
    static constexpr std::uintptr_t PROPERTY_DATA = 0x2ECFF10;
...
{
    static constexpr std::uintptr_t GO_TYPE_DATA = 0x3508EB0;
...
{
    std::shared_ptr<Process> wow = ProcessTools::Open(_T("Wow.exe"), 38134, true);
    if (!wow)
        return 1;
