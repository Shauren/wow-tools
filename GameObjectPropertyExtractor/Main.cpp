...
{
    static constexpr std::uintptr_t PROPERTY_DATA = 0x37D3BB0;
    static constexpr std::size_t MAX_PROPERTY_INDEX = 265;
...
{
    static constexpr std::uintptr_t GO_TYPE_DATA = 0x41C65E0;
