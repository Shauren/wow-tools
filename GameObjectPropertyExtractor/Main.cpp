...
{
    static constexpr std::uintptr_t PROPERTY_DATA = 0x3C0F540;
...
{
    static constexpr std::uintptr_t GO_TYPE_DATA = 0x442EDC0;
...
{
    std::shared_ptr<Process> wow = ProcessTools::Open(_T("Wow_11.1.0.59324-T-64_orig.exe"), 59324, true);
    if (!wow)
        return 1;
