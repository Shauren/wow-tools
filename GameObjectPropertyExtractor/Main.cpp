...
{
    static constexpr std::uintptr_t PROPERTY_DATA = 0x39CAB20;
...
{
    static constexpr std::uintptr_t GO_TYPE_DATA = 0x405D350;
...
{
    std::shared_ptr<Process> wow = ProcessTools::Open(_T("WowT.exe"), 50893, true);
    if (!wow)
        return 1;
