...
{
    static constexpr std::uintptr_t PROPERTY_DATA = 0x3532DD0;
    static constexpr std::size_t MAX_PROPERTY_INDEX = 264;
...
{
    static constexpr std::uintptr_t GO_TYPE_DATA = 0x3D48210;
    ...
    std::uint16_t DataIndexByPropIndex[GameObjectProperty::MAX_PROPERTY_INDEX];
};
