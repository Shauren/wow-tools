...
{
    static constexpr std::uintptr_t PROPERTY_DATA = 0x452C3E0;
    static constexpr std::size_t MAX_PROPERTY_INDEX = 262;
...
{
    static constexpr std::uintptr_t GO_TYPE_DATA = 0x4DE7420;
