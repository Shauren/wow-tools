...
{
    static constexpr std::uintptr_t PROPERTY_DATA = 0x3C96030;
...
{
    static constexpr std::uintptr_t GO_TYPE_DATA = 0x4382510;
...
{
    std::shared_ptr<Process> wow = ProcessTools::Open(_T("WowT.exe"), 50199, true);
    if (!wow)
        return 1;
