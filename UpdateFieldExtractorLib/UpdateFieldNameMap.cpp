...
NameMapping NameMap[] =
{
    ...
    { "CGPlayerData::local.trialXP", "PLAYER_TRIAL_XP" },
    ...
    { "CGPlayerData::local.dodgePercentageFromAttribute", "PLAYER_DODGE_PERCENTAGE_FROM_ATTRIBUTE" },
    { "CGPlayerData::local.parryPercentage", "PLAYER_PARRY_PERCENTAGE" },
    { "CGPlayerData::local.parryPercentageFromAttribute", "PLAYER_PARRY_PERCENTAGE_FROM_ATTRIBUTE" },
    ...
    { "CGPlayerData::local.numRespecs", "PLAYER_FIELD_BYTES" },
    ...
    { "CGPlayerData::local.numBackpackSlots", "PLAYER_FIELD_BYTES2" },
    ...
    { "CGPlayerDynamicData::selfResSpells", "PLAYER_DYNAMIC_FIELD_SELF_RES_SPELLS" },
